...
from resx_hooks.check_placeholders import check_placeholder_consistency
from resx_hooks.resx_parser import find_placeholders, parse_resx_file
...
<root>
  ...
  <data name="Error" xml:space="preserve">
    <value>Erreur: {1} s'est produite</value>
        ...
        parsed_data = {
            en_path: parse_resx_file(en_path),
            fr_path: parse_resx_file(fr_path)
        }

        inconsistencies = check_placeholder_consistency(parsed_data)
...
<root>
  ...
  <data name="Goodbye" xml:space="preserve">
    <value>Goodbye {0}, see you again!</value>
        ...
        parsed_data = {
            path1: parse_resx_file(path1),
            path2: parse_resx_file(path2)
        }
